...
class HeroSliderOne extends Component{
    ...
    render(){
        ...
        let data = [
            {bgImg: 'slider3.jpg', sliderTitle: 'Build Your Dream With Passion', sliderSubtitle: 'Loem ipsum dolor sit amet consectetur adipisicing elit sed do eiusm tempor incididunt ut labore et dolore.', btnLink: 'contact-us'},
            {bgImg: 'slider2.jpg', sliderTitle: 'Build Your Dream With Passion', sliderSubtitle: 'Nail polish, nail treatments, and manicure/pedicure tools.', btnLink: 'contact-us'},
